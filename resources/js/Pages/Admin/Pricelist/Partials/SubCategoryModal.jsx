        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white dark:bg-brand-black w-full max-w-md rounded-3xl overflow-hidden shadow-[0_32px_64px_-15px_rgba(0,0,0,0.5)] border border-black/5 dark:border-white/5">
                ...
                <form onSubmit={submit} className="p-8 space-y-6">
                    <div>
                        <label className="block text-[10px] font-black uppercase tracking-widest text-brand-black/40 dark:text-brand-white/40 mb-2">Nama Sub-Kategori</label>
                        <input
                            type="text"
                            value={data.name}
                            ...
                            placeholder="Contoh: L M R, PRE POST WEDD, dsb"
                            required
                        />
                    ...
                    >
                        {processing ? 'Menyimpan...' : 'Simpan Sub-Kategori'}
                    </button>
                </form>
            </div>
        </div>
